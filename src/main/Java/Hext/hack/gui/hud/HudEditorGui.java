...
import hext.features.hud.HudElement;
import hext.features.modules.Module;
import hext.features.modules.client.ClickGui;
import hext.gui.clickui.AbstractCategory;
import hext.gui.clickui.Category;
...
public class HudEditorGui extends Screen {
    ...
    @Override
    public void removed() {
        Hext.EVENT_BUS.unsubscribe(this);
    }
