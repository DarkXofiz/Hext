package hext.gui.clickui.impl;

import net.minecraft.client.gui.DrawContext;
import net.minecraft.client.util.math.MatrixStack;
import hext.Hext;
import hext.gui.clickui.AbstractElement;
import hext.gui.font.FontRenderers;
import hext.setting.Setting;
import hext.setting.impl.ColorSetting;
import hext.utility.math.MathUtility;
...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        boolean dark = Render2DEngine.isDark(Hext.copy_color);
        ...
        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, Hext.copy_color);
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        else if (copyHovered) Hext.copy_color = getColorSetting().getColorObject();

        else if (pasteHovered) getColorSetting().setColor(Hext.copy_color.getRGB());
