...
import hext.features.modules.client.BaritoneSettings;
import hext.features.modules.client.ClickGui;
import hext.features.modules.client.HudEditor;
import hext.gui.clickui.impl.SearchBar;
...
public class Category extends AbstractCategory {
    ...
    public Category(Module.Category category, ArrayList<Module> features, float x, float y, float width, float height) {
        ...
        ICON = Identifier.of("hext", "textures/gui/headers/" + (Module.Category.isCustomCategory(category) ? "stock" : category.getName().toLowerCase()) + ".png");

        if (category.getName().equals("Client"))
            buttons.add(new SearchBar());

        features.forEach(feature -> {
            if (!(feature instanceof BaritoneSettings) || Hext.baritone)
