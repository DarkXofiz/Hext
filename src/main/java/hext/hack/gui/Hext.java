...
import hext.core.Core;
import hext.core.Managers;
import hext.core.manager.client.*;
import hext.core.hooks.ManagerShutdownHook;
import hext.core.hooks.ModuleShutdownHook;
import hext.utility.ThunderUtility;
import hext.utility.render.Render2DEngine;

import java.awt.*;
import java.lang.invoke.MethodHandles;

public class Hext implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        EVENT_BUS.registerLambdaFactory("hext",
        ...
        LOGGER.info("[Hext] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
